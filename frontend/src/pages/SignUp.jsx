            ...
            <form onSubmit={handleCreateAccount} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  >
                    {showPassword ? <EyeOff className="w-5 h-5" aria-label={showPassword ? 'Hide password' : 'Show password'} /> : <Eye className="w-5 h-5" aria-label={showPassword ? 'Hide password' : 'Show password'} />}
                  </button>
                </div>
              </div>
